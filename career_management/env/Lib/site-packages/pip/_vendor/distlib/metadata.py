...
class LegacyMetadata(object):
    ...
    def _remove_line_prefix(self, value):
        if self.metadata_format_version in ('1.0', '1.1'):
    ...
    @property
    def metadata_format_version(self):
        """Get the metadata format version."""
        return self._fields.get('Metadata-Version', '1.0')
...
class Metadata(object):
    ...
    SYNTAX_VALIDATORS = {
        'metadata_format_version': (METADATA_VERSION_MATCHER, ()),
    ...
    def __init__(self, path=None, fileobj=None, mapping=None, scheme='default'):
        ...
        if mapping is not None:
            ...
            if data is None:
                ...
                self._data = {
                    'metadata_format_version': self.METADATA_VERSION,
    ...
    mapped_keys = {
        ...
        'metadata_format_version': ('Metadata-Version', None),
    }
